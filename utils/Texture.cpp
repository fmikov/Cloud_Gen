...
{
	stbi_set_flip_vertically_on_load(1); //flip texture upside down, in opengl bottom left is (0, 0)
	m_LocalBuffer = stbi_load(filepath.c_str(), &m_Width, &m_Height, &m_BPP, 4);//want 4 channels, RGBA
